...
export default function Home() {
  ...
  return (
    ...
    <div className="container flex flex-col">
      ...
      <textarea name="text" placeholder="Enter text to translate" className="border border-slate-800 rounded-md p-4 lg:w-[400px]" value={inputText} onChange={handleInputChange} />
    </div>

    <div className="container flex flex-col">
    <Dropdown name="languageTo" value={languageTo} options={languageOptions} onChange={handleLanguageToChange}  />
      <textarea placeholder="Translated text will appear here" className="border border-slate-800 rounded-md p-4 lg:w-[400px]"  value={translatedText}
                    readOnly />
    </div>
    
    </div>

    <button type="submit" className="p-4 mt-4 rounded-md bg-slate-800 text-white" >
Translate
    </button>
    </form>
